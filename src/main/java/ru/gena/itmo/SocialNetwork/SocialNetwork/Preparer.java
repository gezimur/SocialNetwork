    ...
    public String preparer(){
        ...
        isTryingSuccess = instance
                .executeQuery("INSERT INTO PATTERNS VALUES(" +
                        ...
                        "'', " +
                        "'');");
        if (!isTryingSuccess) { return "problem with insert values0 into patterns"; }
        isTryingSuccess = instance
                .executeQuery("INSERT INTO PATTERNS VALUES(" +
                        "1, " +
                        "'hand to hand throw', " +
                        "'once 3', " +
                        "'just do it');");
        if (!isTryingSuccess) { return "problem with insert values1 into patterns"; }
        isTryingSuccess = instance
                .executeQuery("INSERT INTO PATTERNS VALUES(" +
                        "2, " +
                        "'throw up', " +
                        "'once 4', " +
                        "'just do it');");
        if (!isTryingSuccess) { return "problem with insert values2 into patterns"; }
        isTryingSuccess = instance
                .executeQuery("INSERT INTO PATTERNS VALUES(" +
                        "3, " +
                        "'cascade', " +
                        "'3', " +
                        "'just do it');");
        if (!isTryingSuccess) { return "problem with insert values3 into patterns"; }
        isTryingSuccess = instance
                .executeQuery("INSERT INTO PATTERNS VALUES(" +
                        "4, " +
                        "'441', " +
                        "'441', " +
                        "'just do it');");
        if (!isTryingSuccess) { return "problem with insert values4 into patterns"; }

        isTryingSuccess = instance
                .executeQuery("INSERT INTO PATTERNSTREE VALUES(" +
                        "0, " +
                        "1);");
        if (!isTryingSuccess) { return "problem with insert values01 into patternsTree"; }
        isTryingSuccess = instance
                .executeQuery("INSERT INTO PATTERNSTREE VALUES(" +
                        "0, " +
                        "2);");
        if (!isTryingSuccess) { return "problem with insert values02 into patternsTree"; }
        isTryingSuccess = instance
                .executeQuery("INSERT INTO PATTERNSTREE VALUES(" +
                        "1, " +
                        "3);");
        if (!isTryingSuccess) { return "problem with insert values13 into patternsTree"; }
        isTryingSuccess = instance
                .executeQuery("INSERT INTO PATTERNSTREE VALUES(" +
                        "2, " +
                        "4);");
        if (!isTryingSuccess) { return "problem with insert values24 into patternsTree"; }
        return null;
    }
}
